...
export default function Hero() {
  ...
  useGSAP(() => {
    ...
    const initPositions = () => {
      ...
      gsap.set(str, { right: 'auto', left: rightInit, visibility: 'visible' });
      ...
      heroTl.to(imageRef.current, { top: '80%', ease: 'none', duration: 0.3 }, 0);
      ...
      <div id="hero-viewport" ref={viewportRef} className="hero-viewport">
        ...
        <div ref={titleContainerRef} className="hero-title-container">
          <h1 className="font-display">
            <LetterHoverText text="JASMINE GUNARTO" />
          </h1>
        </div>

        {/* Center Image — starts between the two side texts */}
        <div ref={imageRef} className="hero-image-container">
          <video src="https://jasminegunarto.com/wp-content/uploads/2026/02/jgunarto_demoreel_compressed_1.mp4" autoPlay loop muted></video>
        </div>
